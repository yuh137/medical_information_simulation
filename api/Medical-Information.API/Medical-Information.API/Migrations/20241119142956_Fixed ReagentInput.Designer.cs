...
namespace Medical_Information.API.Migrations
{
    ...
    [Migration("20241119142956_Fixed ReagentInput")]
    partial class FixedReagentInput
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Medical_Information.API.Models.Domain.AdminQCLot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Department = 0,
                            ExpirationDate = new DateTime(2024, 12, 19, 8, 29, 55, 942, DateTimeKind.Local).AddTicks(6478),
                            FileDate = new DateTime(2024, 11, 19, 8, 29, 55, 942, DateTimeKind.Local).AddTicks(6490),
                            LotNumber = "888888888888",
                            OpenDate = new DateTime(2024, 11, 19, 8, 29, 55, 942, DateTimeKind.Local).AddTicks(6522),
                            QCName = "CMP Level I"
                        });
                });
            ...
            modelBuilder.Entity("Medical_Information.API.Models.Domain.BloodBankQCLot", b =>
                {
                    ...
                    b.HasKey("BloodBankQCLotID");

                    b.ToTable("BloodBankQCLots");
                });
