...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    const [rippleStyle, setRippleStyle] = React.useState<{ left: number; top: number; width: number; height: number } | null>(null);
  ...
  const handleClick = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    setRippleStyle({ left: x, top: y, width: rippleSize, height: rippleSize });

    // Remove ripple effect after a delay
    setTimeout(() => {
      setRippleStyle(null);
