...
export const BFqcTypeLinkList = [
  ...
  {name:"Fluid Crystals", link: "BFcrystals", mockData : 'BFcrystals'},

];

export const UABFtypeLinkList =[
  {name:"BF Level I", link:'BFAnalytes_1', mockData : 'BFAnalytes'},
  {name:"BF Level II", link: "BFAnalytes_2",  mockData : 'BFAnalytes'},
  {name:"BF Level III", link: "BFAnalytes_3", mockData : 'BFAnalytes'},
  {name:"Fluid Crystals", link: "BFcrystals", mockData : 'BFcrystals'},

  {name:"UA Dip I", link:'dip_1', component: 'TestInputPage', mockData : 'Dip'},
  {name:"UA Dip Level II", link: "dip_2", component: 'TestInputPage', mockData : 'Dip'},
  {name:"UA Osmolality", link: "osmolality_1", component: 'TestInputPageCardic', mockData : 'Osmolality'},
  {name:"UA Drug Screen Pos", link: "drugscreen_1", component: 'TestInputPageCardic', mockData : 'DrugScreen'},
  {name:"UA Drug Screen Neg", link: "drugscreen_2", mockData : 'DrugScreen'},
  {name:"UA Clinitest", link: "clinitest", mockData : 'Clinitest'},
  {name:"UA Ictotest", link: "acetest", mockData : 'Acetest'},
  {name:"UA Acetest", link: "ictotest", mockData : 'Ictotest'},
