...
export const bloodBankRBC_QC = [
  ...
  {link:"LewisPos",name:"Lewis Pos QC",bbData:"lewis"},
  {link:"LewisNeg",name:"Lewis Neg QC",bbData:"lewis"},
  {link:"DuffyPos",name:"Duffy Pos QC",bbData:"duffy"},
  {link:"DuffyNeg",name:"Duffy Neg QC",bbData:"duffy"},
  {link:"MNSsPos",name:"MNSs Pos QC",bbData:"mnss"},
  {link:"MNSsNeg",name:"MNSs Neg QC",bbData:"mnss"},
  {link:"LutheranPos",name:"Lutheran Pos QC",bbData:"lutheran"},
  {link:"LutheranNeg",name:"Lutheran Neg QC",bbData:"lutheran"},
  {link:"P1Pos",name:"P1 Pos QC",bbData:"p1"},
  {link:"P1Neg",name:"P1 Neg QC",bbData:"p1"},
