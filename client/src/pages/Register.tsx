    ...
    <>
      <div className="container flex flex-col w-svw bg-[#2f5597]" style={{ minHeight: "100svh", minWidth: "100svw" }}>
        <div className="title w-fit mb-0 mx-auto mt-28 bg-[#3a6cc6] px-12" style={{ maxWidth: "66.67%" }}>
          <div className="title-text font-bold text-ellipsis drop-shadow-xl text-white text-center lg:text-6xl sm:text-4xl py-10">Medical Information Simulations</div>
        </div>
        <div className="login-form min-w-[20%] mb-0 mt-24 mx-auto bg-slate-100 flex flex-col gap-4 py-10 px-4 bg-local bg-cover" style={{ backgroundImage: "url('https://drive.google.com/file/d/1i-Wg9OI01LtsBqRf1dtUGYL5yady9u_J/view?usp=sharing')" }}>
