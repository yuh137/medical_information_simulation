...
var SimpleAnalyteInputPage = function (props) {
    ...
    var _a = react_1.useState(null), qcData = _a[0], setQcData = _a[1];
    var _b = react_1.useState([]), analyteValues = _b[0], setAnalyteValues = _b[1];
    var _c = react_1.useState(null), invalidIndexes = _c[0], setInvalidIndexes = _c[1];
    var _d = react_1.useState(false), isModalOpen = _d[0], setIsModalOpen = _d[1];
    var _e = react_1.useState([]), modalData = _e[0], setModalData = _e[1];
    var _f = react_1.useState(false), isValidManual = _f[0], setIsValidManual = _f[1];
    var _g = react_1.useState(false), isInputFull = _g[0], setIsInputFull = _g[1];
    ...
    var handleInputChange = function (index, value, min, max) {
    ...
    var handleTextareaChange = function (index, invalidIndex, value) {
        setModalData(function (prevValues) {
            var updatedValues = __spreadArrays(prevValues);
            updatedValues[index] = { invalidIndex: invalidIndex, comment: value };
    ...
    var reportPDF = function (analyteValues, QCData) {
        ...
        return (react_1["default"].createElement(renderer_1.Document, { style: tw("border border-solid border-black") },
            react_1["default"].createElement(renderer_1.Page, { style: tw("py-8 px-16 border border-solid border-black") },
                ...
                react_1["default"].createElement(renderer_1.View, null, modalData.map(function (item, index) { return (react_1["default"].createElement(renderer_1.View, { style: tw("flex-row items-center"), key: index },
                    react_1["default"].createElement(renderer_1.View, { style: tw("self-center w-[4px] h-[4px] bg-black rounded-full") }),
                    react_1["default"].createElement(renderer_1.Text, { style: tw("text-[13px] w-full px-6 text-justify text-wrap mt-2") }, QCData === null || QCData === void 0 ? void 0 :
    ...
    var openPDF = function () { return __awaiter(void 0, void 0, void 0, function () {
        var blob, pdfUrl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, renderer_1.pdf(reportPDF(analyteValues, qcData || undefined)).toBlob()];
                case 1:
                    blob = _a.sent();
    ...
    if (!qcData) {
        return react_1["default"].createElement("p", null, "No data available for this QC record.");
    }
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(NavBar_1["default"], { name: props.name + " QC Results" }),
        react_1["default"].createElement("div", { className: "flex flex-col space-y-12 pb-8 justify-center px-[100px] relative", style: { minWidth: "100svw", minHeight: "100svh" } },
            react_1["default"].createElement("div", { className: "analyte-list-container flex flex-wrap gap-14 sm:w-[90svw] sm:px-[149.5px] max-sm:flex-col mt-8 px-3 justify-center" }, qcData.analytes.map(function (item, index) { return (react_1["default"].createElement("div", { onKeyDown: function (event) {
            ...
            react_1["default"].createElement("div", { className: "analyte-control-container sm:w-[90svw] w-[100svw] flex justify-between max-sm:flex-col max-sm:w-[100%] max-sm:space-y-4" },
                ...
                react_1["default"].createElement("div", { className: "sm:space-x-16 max-sm:w-full max-sm:space-y-4" },
                    react_1["default"].createElement(material_1.Button, { className: "sm:w-32 sm:h-[50px] !font-semibold !border !border-solid !border-[#6781AF] max-sm:w-full " + (isInputFull ? "!bg-[#DAE3F3] !text-black" : "!bg-[#AFABAB] !text-white"), disabled: !isInputFull, onClick: function () { return setIsModalOpen(true); } }, "Apply QC Comment"),
                    react_1["default"].createElement(material_1.Button, { className: "sm:w-32 sm:h-[50px] !font-semibold !border !border-solid !border-[#6781AF] max-sm:w-full " + (isValid || isValidManual ? "!bg-[#DAE3F3] !text-black" : "!bg-[#AFABAB] !text-white"), disabled: !isValidManual && !isValid, onClick: function () { return openPDF(); } }, "Print QC"),
                    react_1["default"].createElement(material_1.Button, { className: "sm:w-32 sm:h-[50px] !font-semibold !border !border-solid !border-[#6781AF] max-sm:w-full " + (isValid ? "!bg-[#DAE3F3] !text-black" : "!bg-[#AFABAB] !text-white"), disabled: !isValid, onClick: function () { return handleAcceptQC(); } }, "Accept QC")))),
        react_1["default"].createElement(material_1.Modal, { open: isModalOpen, onClose: function () { return setIsModalOpen(false); } },
            react_1["default"].createElement("div", { className: "modal-conatiner absolute top-1/1 left-1/2 sm:w-[50svw] sm:h-[80svh] bg-[" + theme.secondaryColor + "] border-2 border-solid border-[#6781AF] rounded-xl sm:-translate-x-1/2 sm:translate-y-12 flex flex-col items-center sm:py-6 relative overflow-scroll sm:space-y-4" },
                ...
                react_1["default"].createElement("div", { className: "invalid-items sm:w-[80%]" },
                    ...
                    invalidIndexArray && invalidIndexArray.length > 0 && (react_1["default"].createElement("div", { className: "invalid-items-comments flex flex-col sm:space-y-6" },
                        invalidIndexArray.map(function (invalidItem, index) {
                            ...
                            return (react_1["default"].createElement("div", { className: "comment flex sm:space-x-12 h-fit", key: invalidItem },
                                react_1["default"].createElement("div", { className: "comment-name w-[5%] sm:text-xl font-semibold self-center", dangerouslySetInnerHTML: { __html: (_a = analyteNameRefs.current[invalidItem]) === null || _a === void 0 ? void 0 : _a.innerHTML } }),
                                react_1["default"].createElement("textarea", { className: "grow sm:h-16 p-1", value: ((_b = modalData[index]) === null || _b === void 0 ? void 0 : _b.comment) || "", onChange: function (e) { return handleTextareaChange(index, invalidItem, e.target.value); }, required: true })));
                        }),
                        react_1["default"].createElement(material_1.ButtonBase, { className: "!rounded-lg sm!my-10 sm:!py-6 sm:!px-10 !bg-[" + theme.secondaryColor + "] !border-[1px] !border-solid !border-[" + theme.primaryBorderColor + "] transition ease-in-out hover:!bg-[" + theme.primaryHoverColor + "] hover:!border-[#2F528F] sm:w-1/2 self-center", onClick: function () {
                                setIsValidManual(modalData.every(function (item) { return item.comment !== ""; }));
                            } }, "Apply Comments"))))))));
};
exports["default"] = SimpleAnalyteInputPage;
