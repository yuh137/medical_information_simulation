...
import { qcTypeLinkList, BFqcTypeLinkList } from "../../../utils/UrinalysisUtils";
...
const BFEditQC = () => {
  ...
  return (
    <>
      <NavBar name={`Edit BF QC`} />
      <div className="basic-container">
      <div className={`edit-qc-options flex flex-wrap sm:justify-center sm:p-24 sm:w-[100svw] sm:gap-y-6 sm:gap-x-4 mx-auto`}>
        {BFqcTypeLinkList.map((item) => (
          <ButtonBase
            key={item.name}
        ...
        <div className="button-container flex justify-center sm:-translate-y-12 sm:space-x-36 sm:pb-6">
          <Link to={`/UA_fluids/BFEdit_qc/${selectedItem}`}>
