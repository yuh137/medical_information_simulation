...
const UABFLeveyAnalyteInputPage = (props: { name: string, link?: string }) => {
            ...
            <View>
              {analyteValues?.map((value, index) => (
                <View style={tw("flex-row justify-between mb-2")} key={index}>
                  ...
                  >
                    {parseFloat(value)} {QCData?.analytes[index].unit_of_measure}
                  </Text>
                  {/* Range */}
                  <Text
                    style={tw(
                  ...
                  >
                    ...
                    {QCData?.analytes[index].max_level} {QCData?.analytes[index].unit_of_measure}
                  </Text>
                </View>
              ))}
            </View>
...
export default UABFLeveyAnalyteInputPage;
