...
import { qcTypeLinkList } from "../../../utils/UrinalysisUtils";
import { ButtonBase } from "@mui/material";

const UrinalysisEditQC = () => {
  ...
  return (
    <>
      <NavBar name={`Edit Urinalysis QC​`} />
      <div className="basic-container">
        ...
        <div className="button-container flex justify-center sm:-translate-y-12 sm:space-x-36 sm:pb-6">
          <Link to={`/UA_fluids/edit_qc/${selectedItem}`}>
...
export default UrinalysisEditQC;
